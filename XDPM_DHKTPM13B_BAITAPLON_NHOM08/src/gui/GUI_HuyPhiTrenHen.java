...
public class GUI_HuyPhiTrenHen implements ActionListener, MouseListener {
	private GUI_Store store_GUI = new GUI_Store();
	private JTextField txtTimKhachHang, txthoTen, txtsoPhone, txtSoCMND, txtIDKH, txtNhapID
						,txtMaPhieu, txtIdDVD, txtNgayThue, txtNgayTra, txtPhiTreHen;
	private JButton btnTimKhachHang, btnHuy, btnChonPhi, btnXoaPhi;
	...
	public JPanel designGUI() {
		...
		conn.setLayout(null);
		conn.add(store_GUI.createLable(500, 20, 300, 50, "HỦY PHÍ TRỄ HẸN "));
		...
		jdkNgayThanhToan = store_GUI.createJDatePicker(30, 180, 150, 30);
		...
		btnHuy = store_GUI.createButton(170, 450, 180, 40, "HỦY PHÍ TRỄ HẸN");
		conn.add(btnHuy);
	...
	private JPanel taoPanleBangPhiTreHen() {
		JPanel pnPhiTreHen = store_GUI.createPannel(600, 210, 700, 210, "Bảng Danh Sách Khoản Phí Trễ Hẹn");
	...
	private JPanel taoPanleTTChiTietKhachHang() {
		JPanel pnPhiTreHen = store_GUI.createPannel(30, 210, 500, 210, "Thông Tin Chi Tiết Khách Hàng");
